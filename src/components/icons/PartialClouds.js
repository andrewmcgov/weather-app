...
class PartialClouds extends React.Component {
  render() {
    return (
      <svg
        version="1.1"
      ...
      >
		...
		C33.061,36.317,29.721,39.658,25.615,39.658z"
          ...
          <g>
            ...
            <g>
              <path
                d="M30.15,11.695c-0.276,0-0.5-0.224-0.5-0.5V7.442c0-0.276,0.224-0.5,0.5-0.5s0.5,0.224,0.5,0.5v3.753
				C30.65,11.471,30.426,11.695,30.15,11.695z"
              />
            </g>
            <g>
              <path
                d="M46.1,23.89h-3.753c-0.276,0-0.5-0.224-0.5-0.5s0.224-0.5,0.5-0.5H46.1c0.276,0,0.5,0.224,0.5,0.5
				S46.376,23.89,46.1,23.89z"
              />
            </g>
            <g>
              <path
                d="M38.774,15.266c-0.128,0-0.256-0.049-0.354-0.146c-0.195-0.195-0.195-0.512,0-0.707l2.654-2.653
				c0.195-0.195,0.512-0.195,0.707,0s0.195,0.512,0,0.707l-2.654,2.653C39.03,15.217,38.902,15.266,38.774,15.266z"
              />
            </g>
            <g>
              <path
                d="M41.427,35.168c-0.128,0-0.256-0.049-0.354-0.146L38.42,32.37c-0.195-0.195-0.195-0.512,0-0.707s0.512-0.195,0.707,0
				l2.653,2.652c0.195,0.195,0.195,0.512,0,0.707C41.683,35.12,41.555,35.168,41.427,35.168z"
              />
              <path
                d="M21.524,15.266c-0.128,0-0.256-0.049-0.354-0.146l-2.652-2.653c-0.195-0.195-0.195-0.512,0-0.707s0.512-0.195,0.707,0
